 ...
 *
 *  @param paymentInfo cannot be nil
 *  @param paymentChannelId cannot be nil
 *  @param showingDefaultSummary if true, SDK will present default payment summary page
 *  @param completion cannot be nil
 */
- (void)fastPaymentWithPaymentInfo:(DPPaymentInfo *)paymentInfo paymentChannelId:(NSNumber *)channelId showingDefaultSummary:(BOOL)defaultSummary withCompletion:(void (^)(DPPaymentSummary *_Nullable jsonResponse, NSError * _Nullable error))completion;

/*!
 *  makes  payment using apple pay
 *
 *  @param paymentInfo cannot be nil
 *  @param parentController cannot be nil
 *  @param completionHandler cannot be nil
 */
- (void)applePayPaymentWithPaymentInfo:(DPPaymentInfo *)paymentInfo parentController:(UIViewController *)controller completionHandler:(void (^)(DPPaymentSummary *_Nullable summary, NSError * _Nullable error))completion;
